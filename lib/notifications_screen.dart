  ...
  Future<void> _sendTestNotification() async {
    try {
      ...
      if (web.Notification.permission != 'granted') {
        final permissionJs = await web.Notification.requestPermission().toDart;

        final permission = (permissionJs).toDart;
      ...
      web.Notification(
        'Habit Reminder',
        web.NotificationOptions(body: "It's time to work on your habits!"),
      );
