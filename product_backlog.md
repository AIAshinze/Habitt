...
**Description:** As a user, I want to access my profile page from the menu, so that I can view and edit my personal information.  
**Labels:** `enhancement`, `priority: medium`
...
**Description:** As a user, I want to assign a specific color to each habit, so that I can personalize my habits.  
**Labels:** `enhancement`, `priority: low`
